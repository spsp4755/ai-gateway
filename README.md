...
```powershell
.\scripts\build-airgap-bundle.ps1 -Version 0.1.2
```

The script produces:

- `ai-gateway_0.1.2_linux_amd64.tar.gz`
- `ai-gateway_0.1.2_docker-image.tar`
- `ai-gateway_0.1.2_source.zip`
- `ai-gateway_0.1.2_airgap-bundle.zip`
- `ai-gateway_0.1.2_checksums.txt`
